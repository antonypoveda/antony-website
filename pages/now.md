...
### On the side
* Taking advantage of spare moments to add little bits to this site, like a [Links](/links) page, a proper footer, and this [Now](/now) page.
* Looking at what to do with the [Rising Ape Collective](https://rising-ape.com) website with my friends in Bristol - hoping to archive it gracefully, so much brilliant work recorded there.
...
* Website design and content strategy for the [new Government Cyber Profession](https://www.gov.uk/government/news/government-cuts-cyber-attack-fix-times-by-84-and-launches-new-profession-to-protect-public-services), including the first version of its capability framework.

### On the side
* Setting up the [next 'X-Gov Sheffield meetup'](https://forms.office.com/Pages/ResponsePage.aspx?id=BXCsy8EC60O0l-ZJLRst2Jfxi-sLUdBKhBJgQJpcEshUNUtXM0VXNEJTTlgyUzlPV0lUVEhLUFEyRC4u) for public sector folk around here, Tuesday 17 March.
